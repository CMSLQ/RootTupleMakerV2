...
produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  std::unique_ptr<std::vector<float> >  ecalIsoDR04  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  hcalIsoDR04  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  hcalIsoDR04FullCone  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  trkIsoSolidDR04  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  trkIsoHollowDR04  ( new std::vector<float>()  );
  ...
  std::unique_ptr<std::vector<float> >  trkIsoSolidDR03  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  trkIsoHollowDR03  ( new std::vector<float>()  );
  ...
  std::unique_ptr<std::vector<bool> >   hasPixelSeed  ( new std::vector<bool>()  );
  std::unique_ptr<std::vector<float> >  SCseedEnergy  ( new std::vector<float>()  );
  ...
  std::unique_ptr<std::vector<float> >  E3x3  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  E5x5  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<bool> >   hasMatchedPromptEle  ( new std::vector<bool>()  );
  std::unique_ptr<std::vector<bool> >   isEBGap  ( new std::vector<bool>()  );
  std::unique_ptr<std::vector<bool> >   isEEGap  ( new std::vector<bool>()  );
  std::unique_ptr<std::vector<bool> >   isEBEEGap  ( new std::vector<bool>()  );
  std::unique_ptr<std::vector<bool> >   hasMatchedConvPhot  ( new std::vector<bool>()  );
  std::unique_ptr<std::vector<int> >    nTracksConvPhot  ( new std::vector<int>()  );
  std::unique_ptr<std::vector<float> >  pairInvariantMassConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  pairCotThetaSeparationConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  pairMomentumxConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  pairMomentumyConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  pairMomentumzConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  chi2ConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  nDofConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  xVtxConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  yVtxConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  zVtxConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  eOverPConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  distOfMinApproachConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  dPhiTracksAtVtxConvPhot  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  timeSeed  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  e4SwissCross  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  sMajMaj  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  sMinMin  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  alpha  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  sEtaEta  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  sEtaPhi  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  sPhiPhi  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  e2OverE9  ( new std::vector<float>()  );
  ...
  iEvent.put(std::move(ecalIsoDR04), prefix + "EcalIsoDR04" + suffix );
  iEvent.put(std::move(hcalIsoDR04), prefix + "HcalIsoDR04" + suffix );
  iEvent.put(std::move(hcalIsoDR04FullCone), prefix + "HcalIsoDR04FullCone" + suffix );
  iEvent.put(std::move(trkIsoHollowDR04), prefix + "TrkIsoHollowDR04" + suffix );
  iEvent.put(std::move(trkIsoSolidDR04), prefix + "TrkIsoSolidDR04" + suffix );
  ...
  iEvent.put(std::move(trkIsoHollowDR03), prefix + "TrkIsoHollowDR03" + suffix );
  iEvent.put(std::move(trkIsoSolidDR03), prefix + "TrkIsoSolidDR03" + suffix );
  iEvent.put(std::move(hoe), prefix + "HoE" + suffix );
  iEvent.put(std::move(sigmaIetaIeta), prefix + "SigmaIEtaIEta" + suffix );
  iEvent.put(std::move(hasPixelSeed), prefix + "HasPixelSeed" + suffix );
  iEvent.put(std::move(SCseedEnergy), prefix + "SCseedEnergy" + suffix );
  ...
  iEvent.put(std::move(E3x3), prefix + "E3x3" + suffix );
  iEvent.put(std::move(E5x5), prefix + "E5x5" + suffix );
  iEvent.put(std::move(hasMatchedPromptEle), prefix + "HasMatchedPromptEle" + suffix );
  iEvent.put(std::move(isEBGap), prefix + "IsEBGap" + suffix );
  iEvent.put(std::move(isEEGap), prefix + "IsEEGap" + suffix );
  iEvent.put(std::move(isEBEEGap), prefix + "IsEBEEGap" + suffix );
  //photon conversions
  iEvent.put(std::move(hasMatchedConvPhot), prefix + "HasMatchedConvPhot" + suffix );
  iEvent.put(std::move(nTracksConvPhot), prefix + "NTracksConvPhot" + suffix );
  iEvent.put(std::move(pairInvariantMassConvPhot), prefix + "PairInvariantMassConvPhot" + suffix );
  iEvent.put(std::move(pairCotThetaSeparationConvPhot), prefix + "PairCotThetaSeparationConvPhot" + suffix );
  iEvent.put(std::move(pairMomentumxConvPhot), prefix + "PairMomentumxConvPhot" + suffix );
  iEvent.put(std::move(pairMomentumyConvPhot), prefix + "PairMomentumyConvPhot" + suffix );
  iEvent.put(std::move(pairMomentumzConvPhot), prefix + "PairMomentumzConvPhot" + suffix );
  iEvent.put(std::move(chi2ConvPhot), prefix + "Chi2ConvPhot" + suffix );
  iEvent.put(std::move(nDofConvPhot), prefix + "NDofConvPhot" + suffix );
  iEvent.put(std::move(xVtxConvPhot), prefix + "XVtxConvPhot" + suffix );
  iEvent.put(std::move(yVtxConvPhot), prefix + "YVtxConvPhot" + suffix );
  iEvent.put(std::move(zVtxConvPhot), prefix + "ZVtxConvPhot" + suffix );
  iEvent.put(std::move(eOverPConvPhot), prefix + "EOverPConvPhot" + suffix );
  iEvent.put(std::move(distOfMinApproachConvPhot), prefix + "DistOfMinApproachConvPhot" + suffix );
  iEvent.put(std::move(dPhiTracksAtVtxConvPhot), prefix + "DPhiTracksAtVtxConvPhot" + suffix );
  //variables from ecal rechits
  iEvent.put(std::move(timeSeed), prefix + "TimeSeed" + suffix );
  iEvent.put(std::move(e4SwissCross), prefix + "E4SwissCross" + suffix );
  iEvent.put(std::move(sMajMaj), prefix + "SMajMaj" + suffix );
  iEvent.put(std::move(sMinMin), prefix + "SMinMin" + suffix );
  iEvent.put(std::move(alpha), prefix + "Alpha" + suffix );
  iEvent.put(std::move(sEtaEta), prefix + "SEtaEta" + suffix );
  iEvent.put(std::move(sEtaPhi), prefix + "SEtaPhi" + suffix );
  iEvent.put(std::move(sPhiPhi), prefix + "SPhiPhi" + suffix );
  iEvent.put(std::move(e2OverE9), prefix + "E2OverE9" + suffix );
}
