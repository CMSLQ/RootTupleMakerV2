...
produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  std::unique_ptr<bool>                  hasJetWithBadUnc ( new bool() );
  ...
  std::unique_ptr<std::vector<float> >   mt  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   ptSmearedUp  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   ptSmearedDown  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   ptScaledUp  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   ptScaledDown  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   energySmearedUp  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   energySmearedDown  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   energyScaledUp  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   energyScaledDown  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   pt_raw  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   energy  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   energy_raw ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_AbsoluteStat ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_AbsoluteScale ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_AbsoluteMPFBias ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_Fragmentation ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_SinglePionECAL ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_SinglePionHCAL ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_FlavorQCD ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_TimePtEta ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativeJEREC1 ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativeJEREC2 ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativeJERHF ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativePtBB ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativePtEC1 ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativePtEC2 ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativePtHF ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativeBal ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativeFSR ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativeStatFSR ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativeStatEC ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_RelativeStatHF ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_PileUpDataMC ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_PileUpPtRef ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_PileUpPtBB ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_PileUpPtEC1 ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_PileUpPtEC2 ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jecUnc_vec_PileUpPtHF ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   jecUnc_vec_Total ( new std::vector<float>()  );
  ...
  std::unique_ptr<std::vector<float> >   l2l3resJEC_vec ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   l3absJEC_vec ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   l2relJEC_vec ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   l1fastjetJEC_vec ( new std::vector<float>()  );
  // std::unique_ptr<std::vector<float> >   l1offsetJEC_vec ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   jerRes_vec ( new std::vector<float>() );
  std::unique_ptr<std::vector<float> >   jerResSF_vec ( new std::vector<float>() );
  std::unique_ptr<std::vector<float> >   jerResSFup_vec ( new std::vector<float>() );
  std::unique_ptr<std::vector<float> >   jerResSFdown_vec ( new std::vector<float>() );
  std::unique_ptr<std::vector<int> >     partonFlavour  ( new std::vector<int>()  );
  std::unique_ptr<std::vector<int> >     hadronFlavour  ( new std::vector<int>()  );
  std::unique_ptr<std::vector<float> >   chargedEmEnergyFraction  ( new std::vector<float>()  ) ;
  std::unique_ptr<std::vector<float> >   chargedHadronEnergyFraction  ( new std::vector<float>()  ) ;
  std::unique_ptr<std::vector<float> >   chargedMuEnergyFraction  ( new std::vector<float>()  ) ;
  std::unique_ptr<std::vector<float> >   electronEnergyFraction  ( new std::vector<float>()  ) ;
  std::unique_ptr<std::vector<float> >   muonEnergyFraction  ( new std::vector<float>()  ) ;
  std::unique_ptr<std::vector<float> >   neutralEmEnergyFraction  ( new std::vector<float>()  ) ;
  std::unique_ptr<std::vector<float> >   neutralHadronEnergyFraction  ( new std::vector<float>()  ) ;
  std::unique_ptr<std::vector<float> >   photonEnergyFraction  ( new std::vector<float>()  ) ;
  std::unique_ptr<std::vector<float> >   hfHadronEnergyFraction  ( new std::vector<float>()  ) ;
  std::unique_ptr<std::vector<float> >   hfEMEnergyFraction  ( new std::vector<float>()  ) ;
  std::unique_ptr<std::vector<int> >     chargedHadronMultiplicity  ( new std::vector<int>()  ) ;
  std::unique_ptr<std::vector<int> >     chargedMultiplicity  ( new std::vector<int>()  ) ;
  std::unique_ptr<std::vector<int> >     electronMultiplicity  ( new std::vector<int>()  ) ;
  std::unique_ptr<std::vector<int> >     muonMultiplicity  ( new std::vector<int>()  ) ;
  std::unique_ptr<std::vector<int> >     neutralHadronMultiplicity  ( new std::vector<int>()  ) ;
  std::unique_ptr<std::vector<int> >     neutralMultiplicity  ( new std::vector<int>()  ) ;
  std::unique_ptr<std::vector<int> >     photonMultiplicity  ( new std::vector<int>()  ) ;
  std::unique_ptr<std::vector<int> >     hfHadronMultiplicity ( new std::vector<int>()  ) ;
  std::unique_ptr<std::vector<int> >     hfEMMultiplicity ( new std::vector<int>()  ) ;
  std::unique_ptr<std::vector<int> >     nConstituents  ( new std::vector<int>()  ) ;
  //std::unique_ptr<std::vector<float> >   trackCountingHighEffBTag  ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   trackCountingHighPurBTag  ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   simpleSecondaryVertexHighEffBTag  ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   simpleSecondaryVertexHighPurBTag  ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   jetProbabilityBTag  ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   jetBProbabilityBTag  ( new std::vector<float>()  );

  //std::unique_ptr<std::vector<float> >   combinedSecondaryVertexBTag          ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   combinedSecondaryVertexMVABTag       ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   softElectronByPtBTag                 ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   softElectronByIP3dBTag               ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   softMuonBTag                         ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   softMuonByPtBTag                     ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   softMuonByIP3dBTag                   ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   combinedInclusiveSecondaryVertexBTag ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >   combinedMVABTag                      ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   combinedCvsLJetTag                   ( new std::vector<float>()  );
  //std::unique_ptr<std::vector<float> >   combinedCvsBJetTag                   ( new std::vector<float>()  );
	
  std::unique_ptr<std::vector<int> >   passLooseID  ( new std::vector<int>()  );
  std::unique_ptr<std::vector<int> >   passTightID  ( new std::vector<int>()  );

  std::unique_ptr<std::vector<float> > jetpileup_mva  ( new std::vector<float>()  );
  ...
  std::unique_ptr<std::vector<float> > softLepDr  ( new std::vector<float>()  );


  std::unique_ptr <std::vector<float> >   bestVertexTrackAssociationFactor  ( new std::vector<float>()  );
  std::unique_ptr <std::vector<int> >     bestVertexTrackAssociationIndex   ( new std::vector<int>()  );
  std::unique_ptr <std::vector<float> >   closestVertexWeighted3DSeparation  ( new std::vector<float>()  );
  std::unique_ptr <std::vector<float> >   closestVertexWeightedXYSeparation  ( new std::vector<float>()  );
  std::unique_ptr <std::vector<float> >   closestVertexWeightedZSeparation  ( new std::vector<float>()  );
  std::unique_ptr <std::vector<int> >     closestVertex3DIndex            ( new std::vector<int>()  );
  std::unique_ptr <std::vector<int> >     closestVertexXYIndex           ( new std::vector<int>()  );
  std::unique_ptr <std::vector<int> >     closestVertexZIndex            ( new std::vector<int>()  );

  std::unique_ptr <std::vector<float > > betaStar        ( new std::vector<float>());
  std::unique_ptr <std::vector<float > > betaStarClassic ( new std::vector<float>());
  std::unique_ptr <std::vector<float > > beta            ( new std::vector<float>());
  std::unique_ptr <std::vector<float > > betaClassic     ( new std::vector<float>());
  ...
  *hasJetWithBadUnc.get() = false;
  ...
  iEvent.put(std::move(hasJetWithBadUnc),prefix + "hasJetWithBadUnc" + suffix );
  iEvent.put(std::move(bestVertexTrackAssociationFactor),prefix + "BestVertexTrackAssociationFactor" + suffix );
  iEvent.put(std::move(bestVertexTrackAssociationIndex),prefix + "BestVertexTrackAssociationIndex" + suffix);
  iEvent.put(std::move(closestVertexWeighted3DSeparation),prefix + "ClosestVertexWeighted3DSeparation" + suffix );
  iEvent.put(std::move(closestVertexWeightedXYSeparation),prefix + "ClosestVertexWeightedXYSeparation" + suffix );
  iEvent.put(std::move(closestVertexWeightedZSeparation),prefix + "ClosestVertexWeightedZSeparation" + suffix );
  iEvent.put(std::move(closestVertex3DIndex),prefix + "ClosestVertex3DIndex" + suffix);
  iEvent.put(std::move(closestVertexXYIndex),prefix + "ClosestVertexXYIndex" + suffix);
  iEvent.put(std::move(closestVertexZIndex),prefix + "ClosestVertexZIndex" + suffix);
  ...
  iEvent.put(std::move(mt), prefix + "Mt" + suffix );
  iEvent.put(std::move(ptSmearedUp), prefix + "SmearedUpPt" + suffix );
  iEvent.put(std::move(ptSmearedDown), prefix + "SmearedDownPt" + suffix );
  iEvent.put(std::move(ptScaledUp), prefix + "ScaledUpPt" + suffix );
  iEvent.put(std::move(ptScaledDown), prefix + "ScaledDownPt" + suffix );
  iEvent.put(std::move(pt_raw), prefix + "PtRaw" + suffix );
  iEvent.put(std::move(energy), prefix + "Energy" + suffix );
  iEvent.put(std::move(energySmearedUp), prefix + "SmearedUpEnergy" + suffix );
  iEvent.put(std::move(energySmearedDown), prefix + "SmearedDownEnergy" + suffix );
  iEvent.put(std::move(energyScaledUp), prefix + "ScaledUpEnergy" + suffix );
  iEvent.put(std::move(energyScaledDown), prefix + "ScaledDownEnergy" + suffix );
  iEvent.put(std::move(energy_raw), prefix + "EnergyRaw" + suffix );
  iEvent.put(std::move(jecUnc_vec), prefix + "JECUnc" + suffix );
  iEvent.put(std::move(jecUnc_vec_AbsoluteStat), prefix + "JECUncAbsoluteStat" + suffix );
  iEvent.put(std::move(jecUnc_vec_AbsoluteScale), prefix + "JECUncAbsoluteScale" + suffix );
  iEvent.put(std::move(jecUnc_vec_AbsoluteMPFBias), prefix + "JECUncAbsoluteMPFBias" + suffix );
  iEvent.put(std::move(jecUnc_vec_Fragmentation), prefix + "JECUncFragmentation" + suffix );
  iEvent.put(std::move(jecUnc_vec_SinglePionECAL), prefix + "JECUncSinglePionECAL" + suffix );
  iEvent.put(std::move(jecUnc_vec_SinglePionHCAL), prefix + "JECUncSinglePionHCAL" + suffix );
  iEvent.put(std::move(jecUnc_vec_FlavorQCD), prefix + "JECUncFlavorQCD" + suffix );
  iEvent.put(std::move(jecUnc_vec_TimePtEta), prefix + "JECUncTimePtEta" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativeJEREC1), prefix + "JECUncRelativeJEREC1" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativeJEREC2), prefix + "JECUncRelativeJEREC2" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativeJERHF), prefix + "JECUncRelativeJERHF" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativePtBB), prefix + "JECUncRelativePtBB" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativePtEC1), prefix + "JECUncRelativePtEC1" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativePtEC2), prefix + "JECUncRelativePtEC2" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativePtHF), prefix + "JECUncRelativePtHF" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativeBal), prefix + "JECUncRelativeBal" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativeFSR), prefix + "JECUncRelativeFSR" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativeStatFSR), prefix + "JECUncRelativeStatFSR" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativeStatEC), prefix + "JECUncRelativeStatEC" + suffix );
  iEvent.put(std::move(jecUnc_vec_RelativeStatHF), prefix + "JECUncRelativeStatHF" + suffix );
  iEvent.put(std::move(jecUnc_vec_PileUpDataMC), prefix + "JECUncPileUpDataMC" + suffix );
  iEvent.put(std::move(jecUnc_vec_PileUpPtRef), prefix + "JECUncPileUpPtRef" + suffix );
  iEvent.put(std::move(jecUnc_vec_PileUpPtBB), prefix + "JECUncPileUpPtBB" + suffix );
  iEvent.put(std::move(jecUnc_vec_PileUpPtEC1), prefix + "JECUncPileUpPtEC1" + suffix );
  iEvent.put(std::move(jecUnc_vec_PileUpPtEC2), prefix + "JECUncPileUpPtEC2" + suffix );
  iEvent.put(std::move(jecUnc_vec_PileUpPtHF), prefix + "JECUncPileUpPtHF" + suffix );
  //iEvent.put(std::move(jecUnc_vec_Total), prefix + "JECUncTotal" + suffix );
  iEvent.put(std::move(l2l3resJEC_vec), prefix + "L2L3ResJEC" + suffix );
  iEvent.put(std::move(l3absJEC_vec), prefix + "L3AbsJEC" + suffix );
  iEvent.put(std::move(l2relJEC_vec), prefix + "L2RelJEC" + suffix );
  iEvent.put(std::move(l1fastjetJEC_vec), prefix + "L1FastJetJEC" + suffix );
  iEvent.put(std::move(jerRes_vec), prefix + "JERRes" + suffix );
  iEvent.put(std::move(jerResSF_vec), prefix + "JERResSF" + suffix );
  iEvent.put(std::move(jerResSFup_vec), prefix + "JERResSFUp" + suffix );
  iEvent.put(std::move(jerResSFdown_vec), prefix + "JERResSFDown" + suffix );
  iEvent.put(std::move(partonFlavour), prefix + "PartonFlavour" + suffix );
  iEvent.put(std::move(hadronFlavour), prefix + "HadronFlavour" + suffix );
  iEvent.put(std::move(chargedEmEnergyFraction),  prefix + "ChargedEmEnergyFraction"  + suffix );
  iEvent.put(std::move(chargedHadronEnergyFraction),  prefix + "ChargedHadronEnergyFraction"  + suffix );
  iEvent.put(std::move(chargedMuEnergyFraction),  prefix + "ChargedMuEnergyFraction"  + suffix );
  iEvent.put(std::move(electronEnergyFraction),  prefix + "ElectronEnergyFraction"  + suffix );
  iEvent.put(std::move(muonEnergyFraction),  prefix + "MuonEnergyFraction"  + suffix );
  iEvent.put(std::move(neutralEmEnergyFraction),  prefix + "NeutralEmEnergyFraction"  + suffix );
  iEvent.put(std::move(neutralHadronEnergyFraction),  prefix + "NeutralHadronEnergyFraction"  + suffix );
  iEvent.put(std::move(photonEnergyFraction),  prefix + "PhotonEnergyFraction"  + suffix );
  iEvent.put(std::move(hfHadronEnergyFraction),  prefix + "HFHadronEnergyFraction"  + suffix );
  iEvent.put(std::move(hfEMEnergyFraction),  prefix + "HFEMEnergyFraction"  + suffix );
  iEvent.put(std::move(chargedHadronMultiplicity),  prefix + "ChargedHadronMultiplicity"  + suffix );
  iEvent.put(std::move(chargedMultiplicity),  prefix + "ChargedMultiplicity"  + suffix );
  ...
  iEvent.put(std::move(neutralMultiplicity),  prefix + "NeutralMultiplicity"  + suffix );
  iEvent.put(std::move(photonMultiplicity),  prefix + "PhotonMultiplicity"  + suffix );
  iEvent.put(std::move(hfHadronMultiplicity),  prefix + "HFHadronMultiplicity"  + suffix );
  iEvent.put(std::move(hfEMMultiplicity),  prefix + "HFEMMultiplicity"  + suffix );
  iEvent.put(std::move(nConstituents),  prefix + "NConstituents"  + suffix );
  //iEvent.put(std::move( trackCountingHighEffBTag), prefix + "TrackCountingHighEffBTag" + suffix );
  //iEvent.put(std::move( trackCountingHighPurBTag), prefix + "TrackCountingHighPurBTag" + suffix );
  //iEvent.put(std::move( simpleSecondaryVertexHighEffBTag), prefix + "SimpleSecondaryVertexHighEffBTag" + suffix );
  //iEvent.put(std::move( simpleSecondaryVertexHighPurBTag), prefix + "SimpleSecondaryVertexHighPurBTag" + suffix );
  //iEvent.put(std::move( jetProbabilityBTag), prefix + "JetProbabilityBTag" + suffix );
  //iEvent.put(std::move( jetBProbabilityBTag), prefix + "JetBProbabilityBTag" + suffix );
  //iEvent.put(std::move( combinedSecondaryVertexBTag         ),prefix + "CombinedSecondaryVertexBTag" + suffix );    
  //iEvent.put(std::move( combinedSecondaryVertexMVABTag      ),prefix + "CombinedSecondaryVertexMVABTag" + suffix ); 
  //iEvent.put(std::move( softElectronByPtBTag                ),prefix + "SoftElectronByPtBTag" + suffix );           
  //iEvent.put(std::move( softElectronByIP3dBTag              ),prefix + "SoftElectronByIP3dBTag" + suffix );         
  //iEvent.put(std::move( softMuonBTag                        ),prefix + "SoftMuonBTag" + suffix );                   
  //iEvent.put(std::move( softMuonByPtBTag                    ),prefix + "SoftMuonByPtBTag" + suffix );               
  //iEvent.put(std::move( softMuonByIP3dBTag                  ),prefix + "SoftMuonByIP3dBTag" + suffix );            
  iEvent.put(std::move(combinedInclusiveSecondaryVertexBTag),prefix + "CombinedInclusiveSecondaryVertexBTag" + suffix );
  iEvent.put(std::move(combinedMVABTag                     ),prefix + "CombinedMVABTag" + suffix ) ;
  //iEvent.put(std::move(combinedCvsLJetTag                  ),prefix + "CombinedCvsLJetTags" + suffix ) ;
  //iEvent.put(std::move(combinedCvsBJetTag                  ),prefix + "CombinedCvsBJetTags" + suffix ) ;
  iEvent.put(std::move(passLooseID), prefix + "PassLooseID" + suffix);
  iEvent.put(std::move(passTightID), prefix + "PassTightID" + suffix);
	
  if(!isPuppiJetColl){
    iEvent.put(std::move(jetpileup_mva), prefix + "PileupMVA" + suffix);
    ...
    iEvent.put(std::move(softLepDr),  prefix + "SoftLepDr"  + suffix);
  }
  iEvent.put(std::move(betaStar       ), prefix + "BetaStar"        + suffix ) ;
  iEvent.put(std::move(betaStarClassic), prefix + "BetaStarClassic" + suffix ) ;
  iEvent.put(std::move(beta           ), prefix + "Beta"            + suffix ) ;
  iEvent.put(std::move(betaClassic    ), prefix + "BetaClassic"     + suffix ) ;
