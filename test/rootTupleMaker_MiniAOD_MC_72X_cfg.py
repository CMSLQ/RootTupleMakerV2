...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = 'PHYS14_25_V1::All')
...
process.source.fileNames = [
    'file:/afs/cern.ch/user/s/scooper/work/private/cmssw/741/ReRunHLTLQSignals741/src/HLTrigger/Configuration/test/outputA.root'
]

# XXX SIC to pick up new re-reun HLT results, process name TEST
process.rootTupleTrigger.HLTInputTag = cms.InputTag('TriggerResults','','TEST')
process.rootTupleTriggerObjects.TriggerBitsTag = cms.InputTag('TriggerResults','','TEST')
...
# https://indico.cern.ch/event/374824/contribution/5/material/slides/0.pdf
