...
class RootTupleMakerV2_Electrons : public edm::EDProducer {
 ...
 private:
  ...
  edm::EDGetTokenT<edm::ValueMap<bool> > electronHLTPreselectionMapToken_;
  edm::EDGetTokenT<edm::ValueMap<bool> > electronHEEPIdMapToken_;
  edm::EDGetTokenT<edm::ValueMap<bool> > electronMVAIdWP80MapToken_;
  edm::EDGetTokenT<edm::ValueMap<bool> > electronMVAIdWP90MapToken_;
  edm::EDGetTokenT<edm::ValueMap<bool> > electronMVAIdHZZMapToken_;
  ...
  edm::EDGetTokenT<edm::ValueMap<vid::CutFlowResult> > eleHLTPreselectionCutFlowResultMapToken_;
  edm::EDGetTokenT<edm::ValueMap<vid::CutFlowResult> > eleHEEPIdCutFlowResultMapToken_;
  edm::EDGetTokenT<edm::ValueMap<vid::CutFlowResult> > eleMVAIdWP80CutFlowResultMapToken_;
  edm::EDGetTokenT<edm::ValueMap<vid::CutFlowResult> > eleMVAIdWP90CutFlowResultMapToken_;
  edm::EDGetTokenT<edm::ValueMap<vid::CutFlowResult> > eleMVAIdHZZCutFlowResultMapToken_;
