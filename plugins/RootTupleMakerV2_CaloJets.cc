...
produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  std::unique_ptr<std::vector<float> >  resEmf  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  hadf  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<int> >     n90Hits  ( new std::vector<int>()  );
  std::unique_ptr<std::vector<float> >  fHPD  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  fRBX  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  sigmaEta  ( new std::vector<float>()  );
  std::unique_ptr<std::vector<float> >  sigmaPhi  ( new std::vector<float>()  );
  ...
  // iEvent.put(std::move(l1offsetJEC_vec), prefix + "L1OffsetJEC" + suffix );
  ...
  iEvent.put(std::move(resEmf), prefix + "resEMF" + suffix );
  iEvent.put(std::move(hadf), prefix + "HADF" + suffix );
  iEvent.put(std::move(n90Hits), prefix + "n90Hits" + suffix );
  iEvent.put(std::move(fHPD), prefix + "fHPD" + suffix );
  iEvent.put(std::move(fRBX), prefix + "fRBX" + suffix );
  iEvent.put(std::move(sigmaEta), prefix + "SigmaEta" + suffix );
  iEvent.put(std::move(sigmaPhi), prefix + "SigmaPhi" + suffix );
